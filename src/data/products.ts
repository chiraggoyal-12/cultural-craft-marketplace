...
export const products: Product[] = [
  ...
  {
    id: "onyx-flower-big",
    name: "Onyx Flower Big",
    price: 3500,
    category: "artisan-home-serenity",
    subcategory: "Decorative Pieces",
    image: "/src/assets/products/onyx-flower-big.jpg",
    images: ["/src/assets/products/onyx-flower-big.jpg"],
    description: "Large onyx flower sculpture with translucent beauty and natural stone patterns.",
    shortDescription: "Large onyx flower decorative piece",
