      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {lifestyleScenes.map((scene) => {
            ...
            return (
              <Card key={scene.id} className="group overflow-hidden hover:shadow-2xl transition-all duration-700 hover:-translate-y-3">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  {/* Gradient overlay */}
                  <div className={`absolute inset-0 bg-gradient-to-t ${scene.gradient} to-black/60`} />
                ...
                <CardContent className="p-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Discover products that enhance your {scene.title.toLowerCase()}
                    </p>
                    <Button
                      variant="outline"
                      size="sm"
